    ...
    socket.emit("getRoom", room, (callback) => {
      if (callback) {
        if (typeof callback === "object") {
          ...
          alert.error(`The room ${room} is already exist.`);
        }
      }
    });
  };
    ...
    <div>
      <Card className={`mb-3 ${styles.outerCardContainer}`}>
        <Card.Body>
            ...
            <Col>
              <div className="form-inline d-flex justify-content-center my-2">
                <div className="form-group">
                  <label htmlFor="nickname">Nickname&emsp;</label>
                  <input
                    id="nickname"
                    value={name}
                    type="text"
          ...
          <Row className="mb-4">
            <Col md="8" sm="12">
              <label htmlFor="create-room">Create a room</label>
              <input
                id="create-room"
                type="number"
                placeholder="Room ID"
          ...
          <Row className="mb-4">
            <Col md="8" sm="12">
              <label htmlFor="join-room">Enter a Room</label>
              <input
                id="join-room"
                type="number"
                placeholder="Room ID"
